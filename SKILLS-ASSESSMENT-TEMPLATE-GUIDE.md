...
| `score` | Number | 10 | **คะแนนของข้อนี้ (1-20)** |
...
| Difficulty | คะแนนแนะนำ | คำอธิบาย |
|-----------|-----------|----------|
| **Beginner** | 5-8 | ข้อง่าย พื้นฐาน |
| **Intermediate** | 10-12 | ข้อปานกลาง |
| **Advanced** | 15-20 | ข้อยาก ต้องใช้ความรู้ลึก |

### ตัวอย่างการให้คะแนน:

```csv
Q001,Full Stack,JavaScript,What is closure?,Option A,Option B,Option C,Option D,1,10,Intermediate
Q002,Full Stack,React,Advanced Hook?,Option A,Option B,Option C,Option D,2,15,Advanced
Q003,Full Stack,HTML,Basic tag?,Option A,Option B,Option C,Option D,1,5,Beginner
```

### การคำนวณคะแนนรวม:

```
คะแนนรวม = (คะแนนที่ได้ / คะแนนเต็ม) × 100

ตัวอย่าง:
- ข้อ 1 (10 คะแนน): ตอบถูก → ได้ 10
- ข้อ 2 (15 คะแนน): ตอบผิด → ได้ 0
- ข้อ 3 (5 คะแนน): ตอบถูก → ได้ 5

คะแนนที่ได้ = 15
คะแนนเต็ม = 30
เปอร์เซ็นต์ = (15/30) × 100 = 50%
```

## ⚠️ สิ่งสำคัญ: correct_answer และ score
