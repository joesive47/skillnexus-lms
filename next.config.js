...
const nextConfig = {
  // RunAll/dev can use an isolated build directory while a production-like
  // server is reading .next. This prevents cross-mode cache and lock conflicts.
  ...
  webpack: (config, { isServer }) => {
    // Keep Webpack's default managedPaths. Clearing it makes Webpack rescan all
    // of node_modules, disables effective dependency snapshots and causes very
    // slow first-page compilation on Windows.
