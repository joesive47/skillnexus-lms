      ...
      <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
        <CardContent className="p-6">
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Select
              value={selectedDifficulty || ALL_FILTERS}
              onValueChange={(value) => setSelectedDifficulty(value === ALL_FILTERS ? '' : value)}
            >
              <SelectTrigger className="bg-gray-800 border-gray-700 text-white">
                <SelectValue placeholder="Difficulty" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value={ALL_FILTERS}>All Levels</SelectItem>
            ...
            <Select
              value={selectedCategory || ALL_FILTERS}
              onValueChange={(value) => setSelectedCategory(value === ALL_FILTERS ? '' : value)}
            >
              <SelectTrigger className="bg-gray-800 border-gray-700 text-white">
