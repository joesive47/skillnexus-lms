      ...
      <CardHeader className="relative">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg">{certKey.name}</CardTitle>
    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { name: "Data Analytics", keys: 3, color: "from-blue-500 to-purple-600", icon: "📊" },
            { name: "Machine Learning", keys: 4, color: "from-green-500 to-blue-600", icon: "🤖" },
            { name: "Business Intelligence", keys: 3, color: "from-purple-500 to-pink-600", icon: "📈" },
            { name: "Cloud Computing", keys: 5, color: "from-orange-500 to-red-600", icon: "☁️" }
          ].map((path, index) => (
            <Card key={index} className="hover:shadow-lg transition-all duration-300 border-2 border-gray-200 hover:border-blue-300">
              <CardContent className="p-4 text-center">
                ...
                <h3 className="font-bold text-gray-800 mb-2">{path.name}</h3>
