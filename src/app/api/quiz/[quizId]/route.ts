...
export async function GET(
  ...
  try {
    ...
    const quizDataResult = await getQuizForStudent(quizId, request.nextUrl.searchParams.get('lessonId') || undefined)
    ...
    return NextResponse.json({
      id: quiz.id,
      title: quiz.title,
      passScore: quizDataResult.quiz.passScore,
      attemptId: quizDataResult.attemptId,
